...
| P05 | Database, ownership, migration foundation | IMPLEMENTED | VP-P05 pending | 2026-07-12 — branch phase/05-database-foundation; expand-only canonical-entities migration, ADR-005 ownership mapping, guarded synthetic seed, 36 unit tests green. BLOCKED items: db push + type generation await user approval of migration target |
